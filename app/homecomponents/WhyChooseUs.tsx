    ...
    <div className="p-3 sm:p-5" id="whycooseus">
      <div className="p-3 sm:p-5 rounded-2xl sm:rounded-3xl lg:rounded-4xl flex flex-col gap-12 sm:gap-16 md:gap-20 lg:gap-24 tracking-tighter">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden border border-gray-200 overflow-x-auto">
          ...
          <div className="grid grid-cols-[1.2fr_0.9fr_0.9fr] sm:grid-cols-[1.5fr_1fr_1fr] md:grid-cols-[2fr_1fr_1fr] bg-stone-200/40 border-b border-gray-200 min-w-[500px] sm:min-w-0">
            ...
            <div className="p-2 sm:p-3 md:p-4 lg:p-5 text-center border-l border-gray-200">
              <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-medium text-[#0891b2] tracking-tighter">E&E</h3>
            </div>
            <div className="p-2 sm:p-3 md:p-4 lg:p-5 text-center border-l border-gray-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4">
          <div className="p-4 sm:p-6 md:p-8 md:border-l border-stone-300 first:border-l-0">
            <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-black tracking-tighter">25+</div>
            <p className="text-sm sm:text-base md:text-lg text-black/60 tracking-tighter mt-1 sm:mt-2">Years Experience</p>
          </div>
          <div className="p-4 sm:p-6 md:p-8 md:border-l border-stone-300">
            <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-black tracking-tighter">1000+</div>
            <p className="text-sm sm:text-base md:text-lg text-black/60 tracking-tighter mt-1 sm:mt-2">Projects Completed</p>
          </div>
          <div className="p-4 sm:p-6 md:p-8 md:border-l border-stone-300">
            <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-black tracking-tighter">5.0★</div>
            <p className="text-sm sm:text-base md:text-lg text-black/60 tracking-tighter mt-1 sm:mt-2">Client Rating</p>
          </div>
          <div className="p-4 sm:p-6 md:p-8 md:border-l border-stone-300">
            <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-black tracking-tighter">3</div>
            <p className="text-sm sm:text-base md:text-lg text-black/60 tracking-tighter mt-1 sm:mt-2">Counties Served</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 sm:gap-8 md:gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 sm:gap-5 md:gap-6">
            {[
              ...
              <div key={index} className={`${step.color} rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300`}>
                <div className="absolute -top-2 -right-2 text-5xl sm:text-6xl md:text-7xl font-bold text-black/5 tracking-tighter select-none">
                  {step.num}
                </div>
                <div className="relative">
                  <div className="text-xs sm:text-sm font-medium text-black/40 mb-1 sm:mb-2">{step.num}</div>
                  <h4 className="text-base sm:text-lg md:text-xl font-semibold text-black/80 mb-1 sm:mb-2 tracking-tighter">{step.title}</h4>
                  <p className="text-xs sm:text-sm text-black/60 tracking-tight leading-relaxed">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
