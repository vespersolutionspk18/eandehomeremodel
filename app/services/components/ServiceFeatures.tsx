        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white rounded-2xl p-5 sm:p-6 md:p-8 border border-stone-200 hover:border-stone-300 hover:shadow-lg active:scale-[0.98] transition-all duration-300 group"
              >
                <div
